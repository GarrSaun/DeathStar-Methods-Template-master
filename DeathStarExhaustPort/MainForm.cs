...
namespace DeathStarExhaustPort
{
    public partial class MainForm : Form
    {
        ...
        {
            float xScale = width / 80;
            float yScale = height / 100;

            Pen linePen = new Pen(Color.White);
            //Crossing Lines
            offScreen.DrawLine(linePen, 20 * xScale + x, 1 * yScale + y, 60*xScale+x, 100*yScale+y); 
            offScreen.DrawLine(linePen, 60 * xScale + x, 1 * yScale + y, 20 * xScale + x, 100 * yScale + y);

            //Triangle Thingies
            offScreen.DrawLine(linePen, 20 * xScale + x, 1 * yScale + y, 1 * xScale + x, 20 * yScale + y); //diagonal left
            offScreen.DrawLine(linePen, 60 * xScale + x, 1 * yScale + y, 80 * xScale + x, 20 * yScale + y); //diagonal right
            offScreen.DrawLine(linePen, 1 * xScale + x, 20 * yScale + y, 20 * xScale + x, 20 * yScale + y); //straight left
            offScreen.DrawLine(linePen, 80 * xScale + x, 20 * yScale + y, 60 * xScale + x, 20 * yScale + y); //straight right

            //Main Shaft
            Pen exPen = new Pen(Color.White);
            offScreen.DrawLine(exPen, 20 *xScale + x, 1 * yScale + y, 20* xScale + x, 100 * yScale + y);
            offScreen.DrawLine(exPen, 10 * xScale + x, 100 * yScale + y, 70* xScale + x, 100 * yScale + y);
            offScreen.DrawLine(exPen, 60 * xScale + x, 100 * yScale + y, 60 * xScale + x, 1 * yScale + y);
            offScreen.DrawArc(exPen, 10 * xScale + x, 70 * yScale + y, 60 * xScale, 60 * yScale, 0, 180);
        }
        //------------------------------------------------------------------------------------
        ...
        private void partButton_Click(object sender, EventArgs e)
        {
            ...
            //ExhaustPort(100, 20, 20, 205);
            ExhaustPort(250, 100, 40, 100);
